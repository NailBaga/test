 ...
 * @property Call $call
 */
class History extends ActiveRecord implements AggregateRoot
{
    use ObjectNameTrait;
    use EventTrait;


    public static function create(string $intTs, Customer $customer, User $user, string $object): self
    {
        $history = new self();
        $history->ins_ts = $intTs;
